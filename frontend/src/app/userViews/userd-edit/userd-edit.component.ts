...
@Component({
  selector: 'app-userd-edit',
  templateUrl: './userd-edit.component.html',
  styleUrls: ['./userd-edit.component.css']
})
export class UserdEditComponent implements OnInit {
  ...
  onDraft(data:any){
    ...
    if(data.title!=''){
      ...
      this.router.navigate(['/user/userdraft'])
    }
    else{
